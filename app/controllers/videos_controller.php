...
class VideosController extends AppController
{
    ...
    public function getCategories($id = NULL)
    {
        ...
        if ($id) {
            $sSQL = 'SELECT * FROM categories WHERE categories.id = $id ORDER BY categories.name ASC';
        } else {
            $sSQL = 'SELECT * FROM categories ORDER BY categories.name ASC';
        }
    ...
    function ratingsave()
    {
        ...
        $ratingSQL = "SELECT * FROM ratings WHERE user_ip='" . $_SERVER['REMOTE_ADDR'] . "' AND video_id='" . $articleid . "'";
    ...
    /*----------------------------------------------------------
    / Get Random Video Tags videos
    / @author: Maran Emil
    ----------------------------------------------------------*/

    function getRandomVideoTags($limit = 10)
    {
    ...
    /*----------------------------------------------------------
    / Get category name by id videos
    / @author: Maran Emil
    ----------------------------------------------------------*/
    ...
    function getRelatedVideos($searchq)
    {
    ...
    /*----------------------------------------------------------
    / List last top videos
    / @author: Maran Emil
    ----------------------------------------------------------*/

    function list_last_topvideos($limit = 9)
    {
