...
class UsersController extends AppController
{
    ...
    public function register()
    {
        ...
        } elseif (!empty($this->data) && $this->data['User']['password'] !== $this->data['User']['password_confirm']) {
    ...
    {
        $this->checkIfLogged();
        // Displays the Usernames of all Members including a link to their blog and user information
     ...
     * @version        1.0
     */
    public function savemyprofileold($id = null)
    {
        if (!is_numeric($id)) {
            $this->redirect('/');
        }
    ...
    public function forgotpassword()
    {
        ...
        if ($this->data) {
            ...
            if ($uDetails && $this->data["User"]["username"] === $uDetails[0]["User"]["username"]) {
                ...
                $message = "To change your password follow the next link:  - <A HREF='//" . $this->webroot . "/users/forgotpasswordtoken/" . $newToken . "'> https://publion.ro/users/forgotpasswordtoken/" . $newToken . " </A>";
    ...
    public function create_password($length = 8, $use_upper = 1, $use_lower = 1, $use_number = 1, $use_custom = "")
    {
        ...
        echo create_password(10,1,1,1,";,:.-_()"); // Returns for example or oZA10kpX
        */
    }
