...
<div style="width: 640px; float: left; padding: 0 5px 5px 5px">
    <h1 style="margin: 0px; color: white"><?= $Video[0]['videos']['bandname'] ?>
            ...
            <div class="videoBoxElem" style="">
                ...
                <div style="margin: 0px; float: left; ">
                    <A HREF="<?php echo $this->webroot . "videos/view/" . $relVideo["videos"]['id'] . "/" . $relVideo["videos"]['bandname']; ?>">
                        ...
                        <span style="margin: 0px; color: #333; font: bold 11px arial"><?php echo $relVideo["videos"]['bandname'] . ' - ' . substr($relVideo["videos"]['songtitle'], 0, 25); ?>
                            ...</span>
                    </A><br/><br/>
