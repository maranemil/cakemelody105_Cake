...
?>
<div id="home_content">
    <h1>Cakephp Web Apps in Wild</h1><br/>
    <ul>
        <!-- best -->
        <li>Best Web Apps</li>
        <li><a href="http://croogo.org/" target="_blank">Croogo CMS</a></li>
        ...
        <!-- commercial -->
        <li><a href="http://www.enovo.dk/" target="_blank"> Simpleworks CMS </a></li>
