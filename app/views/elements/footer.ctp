...
<div id="contentright">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar">
            ...
            <li style="" id="downloadbutton">
                <a href="//code.google.com/p/marancakemelody/" target="_blank" class="downloadbutton">
    ...
    <div class="sidebarcat">
        <ul class="sidebarcat">
            <?php //print_r($this->requestAction('/videos/menucategories/'));	?>
...
<div id="footerbg">
    ...
    <div id="footer">
        ...
        <div id="footerleft">
            ...
            <ul>
                <li><a href="https://www.cakephp.org/" target="_blank">www.cakephp.org</a></li>
                <li><a href="https://cakeforge.org/" target="_blank">cakeforge.org</a></li>
                <li><a href="https://book.cakephp.org/" target="_blank">book.cakephp.org</a></li>
                <li><a href="https://bakery.cakephp.org/" target="_blank">bakery.cakephp.org</a></li>
            </ul>
        </div>
        <!-- / Footer Element Left -->
        ...
        <div id="footerright">
            ...
            <H1>Credits</H1>
            <p>
                Developed with <?php echo $html->link("Emil Maran", "https://www.maran-emil.de"); ?>.<br/>
                Copyright&copy; <?php echo date("Y"); ?> Emil Maran.<br/>
                Idea is based
                on <?php echo $html->link("Pereira Pulido Nuno Ricardo Design", "https://www.namaless.com"); ?>.<br/>
                <?php echo $html->link("xHTML", "https://validator.w3.org/check/referer", array('title' => "This page validates as XHTML 1.0 Transitional")); ?>
                | <?php echo $html->link("CSS", "https://jigsaw.w3.org/css-validator/check/referer", array('title' => "This page validates as CSS")); ?>
            </p>
            <!-- / Credits -->
